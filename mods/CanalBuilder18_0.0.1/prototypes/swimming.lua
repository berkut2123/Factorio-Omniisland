...
data.raw.tile["water"].walking_sound = {
	{
		filename = "__CanalBuilder18__/sounds/water-1.ogg",
		volume = 0.8
	},
	{
		filename = "__CanalBuilder18__/sounds/water-2.ogg",
		volume = 0.8
	},
	{
		filename = "__CanalBuilder18__/sounds/water-3.ogg",
		volume = 0.8
	}
}
...
for i=1,4 do
	data:extend{{
		...
		animation =
		{
			filename = "__CanalBuilder18__/graphics/ripple" .. i .. ".png",
			priority = "extra-high",
			width = 192,
			height = 128,
			frame_count = 48,
