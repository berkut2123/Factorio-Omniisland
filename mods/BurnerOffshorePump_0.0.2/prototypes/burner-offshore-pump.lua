...
local name = 'burner-offshore-pump'

local entity_picture = '__BurnerOffshorePump__/graphics/entity/'..name..'.png'
...
placeholder.pumping_speed = 2 -- 2 is 120 fluids/s, vanilla has 20
-- placeholder.localised_name = {'entity-name.'..name}
placeholder.localised_name = {'burner bop placeholder'}
-- placeholder.order = "b-o-p-a"
...
local entity = {
    ...
    energy_usage = "180kW", -- same as ice melter in the mod "Ice Ore 0.3.0"
