	  ...
	  for _, item in ipairs(itemList) do			
	   ...
	   --if the current entity is an item on the ground with the word "artifact", "corpse", "flesh" or "artifact-ore" in the name, we move it
		...
		if item.valid and item.stack.valid then
		  if string.find(item.stack.name,"artifact") or string.find(item.stack.name,"corpse") or string.find(item.stack.name,"flesh") or string.find(item.stack.name,"chitin") or string.find(item.stack.name,"coin") or string.find(item.stack.name,"xenomass") or string.find(item.stack.name,"body") then
