...
function disconnectAllWires(ent1,ent2)	
	if ent1 and ent2 then
		ent1.disconnect_neighbour{wire=defines.wire_type.red,target_entity=ent2}
		ent1.disconnect_neighbour{wire=defines.wire_type.green,target_entity=ent2}
