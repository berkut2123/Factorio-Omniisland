...
if data.raw.item["steel-pipe"] then
  bobmods.lib.recipe.replace_ingredient("stone-chemical-furnace", "pipe", "steel-pipe")
...
if settings.startup["bobmods-plates-convert-recipes"].value == true then
  ...
  bobmods.lib.tech.add_recipe_unlock("alloy-processing-1", "stone-mixing-furnace-from-stone-furnace")
  bobmods.lib.tech.add_recipe_unlock("alloy-processing-1", "stone-furnace-from-stone-mixing-furnace")
