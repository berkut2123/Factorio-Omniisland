...
function exchange_inventory(data)
    ...
    for signal_name, _ in pairs(itemdata_b) do
        ...
        if transfer_b_a > 0 and (data.b.entity.type == "car" or data.b.entity.type == "spider-vehicle") then
          -- b is pushing
        ...
        elseif transfer_b_a < 0 and (data.a.entity.type == "car" or data.a.entity.type == "spider-vehicle") then
          -- a is pushing
