function reapply_research(force, research) 
	if force.technologies[research] and force.technologies[research].researched then
		...
		force.print({"info-message.sniper-rifle-tech-migration", force.technologies[research].localised_name},{r=0.5,g=1,b=0.5,a=1})
	end
end
...
for _, force in pairs(game.forces) do
	...
	force.reset_recipes()
	for _,research in pairs({"military"}) do
