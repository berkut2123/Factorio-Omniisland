...
function util.tile_to_area(tile_position, margin)
  ...
  return {
    {(tile_position.x or tile_position[1])+margin, (tile_position.y or tile_position[2])+margin},
    {(tile_position.x or tile_position[1])+1-margin, (tile_position.y or tile_position[2])+1-margin}
  }
end
