...
data_util.tech_add_ingredients("spidertron", { data_util.mod_prefix .. "rocket-science-pack", data_util.mod_prefix .. "biological-science-pack-1", data_util.mod_prefix .. "material-science-pack-1"}, true)
data_util.tech_remove_ingredients("spidertron", { "production-science-pack"})
