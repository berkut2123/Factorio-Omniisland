...
function gSets.debugging()
    if (not global) or (not global.settings_cache) or (not global.settings_cache.ammo_loader_debugging) then
        return false
    end
...
--     if (global["profilerEnabled"]) then
--         return true
--     end
--     return false
-- end
...
gSets.maxSlotsCheckProvPerTick = 20
gSets.maxRendersPerTick = 200
-- gSettings._init()
return gSets
