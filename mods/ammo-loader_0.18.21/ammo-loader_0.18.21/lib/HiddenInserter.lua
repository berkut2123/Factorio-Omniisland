    ...
    for i = 1, #ents do
        ...
        if (isValid(ent)) then
            ...
            if (isValid(dropTarget)) then
                ...
                for slot in Force.get(dropTarget.force.name).slots:slotIter() do
                    if (slot.ent == dropTarget) then
