...
script.on_event(defines.events.on_built_entity, function(event)
  ...
  if settings.startup["bobmods-logistics-inserteroverhaul"].value == true and entity.type == "entity-ghost" and entity.ghost_type == "inserter" then
    local surface = entity.surface
    local position = entity.position
    local force = entity.force
    local direction = entity.direction

    if entity.ghost_name == "long-handed-inserter" then
      local new_inserter = entity.surface.create_entity{name = "entity-ghost", inner_name = "red-inserter", position = entity.position, force = entity.force, direction = entity.direction}
      new_inserter.drop_position = entity.drop_position
      new_inserter.pickup_position = entity.pickup_position
      entity.destroy()
    elseif entity.ghost_name == "fast-inserter" then
      local new_inserter = entity.surface.create_entity{name = "entity-ghost", inner_name = "blue-inserter", position = entity.position, force = entity.force, direction = entity.direction}
      new_inserter.drop_position = entity.drop_position
      new_inserter.pickup_position = entity.pickup_position
      entity.destroy()
    elseif entity.ghost_name == "filter-inserter" then
      local new_inserter = entity.surface.create_entity{name = "entity-ghost", inner_name = "blue-filter-inserter", position = entity.position, force = entity.force, direction = entity.direction}
      new_inserter.drop_position = entity.drop_position
      new_inserter.pickup_position = entity.pickup_position
      entity.destroy()
    elseif entity.ghost_name == "stack-inserter" then
      local new_inserter = entity.surface.create_entity{name = "entity-ghost", inner_name = "blue-stack-inserter", position = entity.position, force = entity.force, direction = entity.direction}
      new_inserter.drop_position = entity.drop_position
      new_inserter.pickup_position = entity.pickup_position
      entity.destroy()
    elseif entity.ghost_name == "stack-filter-inserter" then
      local new_inserter = entity.surface.create_entity{name = "entity-ghost", inner_name = "blue-stack-filter-inserter", position = entity.position, force = entity.force, direction = entity.direction}
      new_inserter.drop_position = entity.drop_position
      new_inserter.pickup_position = entity.pickup_position
      entity.destroy()
    end
