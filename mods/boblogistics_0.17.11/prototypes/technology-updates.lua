...
if data.raw.tool["advanced-logistic-science-pack"] then
  ...
  bobmods.lib.tech.replace_science_pack("character-logistic-slots-7", "production-science-pack", "advanced-logistic-science-pack")
  bobmods.lib.tech.replace_science_pack("character-logistic-slots-8", "production-science-pack", "advanced-logistic-science-pack")
  bobmods.lib.tech.replace_science_pack("character-logistic-slots-9", "production-science-pack", "advanced-logistic-science-pack")
  bobmods.lib.tech.replace_science_pack("character-logistic-slots-10", "production-science-pack", "advanced-logistic-science-pack")
...
if data.raw.technology["advanced-logistic-science-pack"] then
  ...
  bobmods.lib.tech.replace_prerequisite("bob-fluid-handling-4", "production-science-pack", "advanced-logistic-science-pack")
  bobmods.lib.tech.replace_prerequisite("bob-armoured-railway-2", "production-science-pack", "advanced-logistic-science-pack")
  bobmods.lib.tech.replace_prerequisite("bob-armoured-fluid-wagon-2", "production-science-pack", "advanced-logistic-science-pack")
  bobmods.lib.tech.replace_prerequisite("bob-robots-2", "production-science-pack", "advanced-logistic-science-pack")
  bobmods.lib.tech.replace_prerequisite("bob-robo-modular-4", "production-science-pack", "advanced-logistic-science-pack")
  ...
  bobmods.lib.tech.remove_prerequisite("character-logistic-slots-4", "production-science-pack")
  bobmods.lib.tech.add_prerequisite("character-logistic-slots-5", "advanced-logistic-science-pack")
