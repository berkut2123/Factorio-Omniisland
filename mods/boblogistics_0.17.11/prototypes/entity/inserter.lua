...
data.raw.inserter["fast-inserter"].next_upgrade = "blue-inserter"
...
data.raw.inserter["filter-inserter"].next_upgrade = "blue-filter-inserter"
...
data.raw.inserter["stack-inserter"].next_upgrade = "blue-stack-inserter"
...
data.raw.inserter["stack-filter-inserter"].next_upgrade = "blue-stack-filter-inserter"
...
data:extend(
{
  util.merge{
    data.raw.inserter["filter-inserter"],
    {
      ...
      minable = {hardness = 0.2, mining_time = 0.5, result = "yellow-filter-inserter"},
  ...
  util.merge{
    data.raw.inserter["filter-inserter"],
    {
      ...
      minable = {hardness = 0.2, mining_time = 0.5, result = "red-filter-inserter"},
      next_upgrade = "blue-filter-inserter",
      extension_speed = 0.07,
      rotation_speed = 0.03,
      energy_per_movement = "5kJ",
      energy_per_rotation = "5kJ",
  ...
  util.merge{
    data.raw.inserter["stack-inserter"],
    {
      ...
      next_upgrade = "blue-stack-inserter",
      extension_speed = 0.07,
      rotation_speed = 0.03,
  ...
  util.merge{
    data.raw.inserter["stack-filter-inserter"],
    {
      ...
      minable = {hardness = 0.2, mining_time = 0.5, result = "red-stack-filter-inserter"},
      next_upgrade = "blue-stack-filter-inserter",
      extension_speed = 0.07,
      rotation_speed = 0.03,
      energy_per_movement = "17.5kJ",
      energy_per_rotation = "17.5kJ",
...
{
  {
    ...
    icon_size = 32,
    flags = {"placeable-neutral", "placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "turbo-inserter"},
    max_health = 200,
    corpse = "small-remnants",
    resistances =
    {
...

  {
    ...
    icon_size = 32,
    flags = {"placeable-neutral", "placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "turbo-filter-inserter"},
    max_health = 200,
    corpse = "small-remnants",
    resistances =
    {
