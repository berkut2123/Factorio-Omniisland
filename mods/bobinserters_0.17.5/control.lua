...
function bobmods.logistics.create_gui(player_index)
  ...
  gui.add({type = "table", name = "table", column_count = 1, style = "bob-table"})
...
function bobmods.inserters.open_gui(entity, player)
  ...
  if globtable.position == "center" then
    gui.add({type = "table", name = "title", column_count = 2, style = "bob-table"})
  ...
  if near_unlocked then
    gui.add({type = "table", name = "main_table", column_count = 5, style = "bob-table"})
  else
    gui.add({type = "table", name = "main_table", column_count = 3, style = "bob-table"})
  end

  if globtable.position == "center" then
    gui.add({type = "flow", name = "button_flow"})
    gui.button_flow.style.horizontally_stretchable = true
    gui.button_flow.style.horizontal_align = "right"
    gui.button_flow.add({type = "button", name = "bob_inserter_gui_close", style = "confirm_button", caption = {"gui.confirm"}})
  end

  gui.main_table.add({type = "table", name = "pickup", column_count = 1, style = "bob-table"})
  gui.main_table.add({type = "label", name = "spacer1", caption = "     " })
  gui.main_table.add({type = "table", name = "drop", column_count = 1, style = "bob-table"})
  if near_unlocked then
    gui.main_table.add({type = "label", name = "spacer2", caption = "     " })
    gui.main_table.add({type = "table", name = "drop_offset", column_count = 1, style = "bob-table"})
    gui.main_table.drop_offset.add({type = "label", name = "entity_name", caption = {"gui.bob-inserter-offset"}})
    globtable.offset = gui.main_table.drop_offset.add({type = "table", name = "bob_inserter_gui_drop_offset", column_count = 3, style = "bob-table"})
  ...
  globtable.pickup = gui.main_table.pickup.add({type = "table", name = "bob_inserter_gui_pickup", column_count = column_count, style = "bob-table"})
  globtable.drop = gui.main_table.drop.add({type = "table", name = "bob_inserter_gui_drop", column_count = column_count, style = "bob-table"})
...
offset: the index in table bobmods.inserters.offset_positions to define the offset location within the drop tile.
  ...
  draw_gui = function(data)
    ...
    if near_unlocked then
      data.gui.add({type = "table", name = "main_table", column_count = 5, style = "bob-table"})
    else
      data.gui.add({type = "table", name = "main_table", column_count = 3, style = "bob-table"})
    end

    data.gui.main_table.add({type = "table", name = "pickup", column_count = 1, style = "bob-table"})
    data.gui.main_table.add({type = "label", name = "spacer1", caption = "     " })
    data.gui.main_table.add({type = "table", name = "drop", column_count = 1, style = "bob-table"})
    ...
    local gui_pickup = data.gui.main_table.pickup.add({type = "table", name = data.name .. "_pickup", column_count = column_count, style = "bob-table"})
    local gui_drop = data.gui.main_table.drop.add({type = "table", name = data.name .. "_drop", column_count = column_count, style = "bob-table"})
    ...
    if near_unlocked then
      ...
      data.gui.main_table.add({type = "table", name = "offset", column_count = 1, style = "bob-table"})
      data.gui.main_table.offset.add({type = "label", name = "entity_name", caption = {"gui.bob-inserter-offset"}})
      local gui_offset = data.gui.main_table.offset.add({type = "table", name = data.name .. "_offset", column_count = 3, style = "bob-table"})
