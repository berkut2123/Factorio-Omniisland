...
data.raw.wall["stone-wall"].icon_mipmaps = 1
...
concrete.icon_mipmaps = data.raw.item["concrete-wall"].icon_mipmaps
...
steel.icon_mipmaps = data.raw.item["steel-wall"].icon_mipmaps
