...
util.tech_add_prerequisites("nuclear-power", {"steam-power","electric-mining"})
...
if data.raw.technology["fast-inserter"] then
  data.raw.technology["fast-inserter"].icon = "__aai-industry__/graphics/technology/fast-inserter.png"
