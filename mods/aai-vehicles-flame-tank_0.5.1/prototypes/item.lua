...
-- fix ammo after 0.15
local flamethrower_ammo = data.raw.ammo["flamethrower-ammo"]
flamethrower_ammo.icon = "__aai-vehicles-flame-tank__/graphics/icons/flamethrower-ammo.png"
flamethrower_ammo.icon_size = 64
flamethrower_ammo.icon_mipmaps = 1
flamethrower_ammo.ammo_type = {
...
flamejet.icon_size = 64
flamejet.icon_mipmaps = 1
flamejet.ammo_type = {
