...
sprites_builder.setFilename(duct_end_points_sprite_path .. "duct_end_point_intake_up.png")
...
sprites_builder.setFilename(duct_end_points_sprite_path .. "duct_end_point_intake_right.png")
...
sprites_builder.setFilename(duct_end_points_sprite_path .. "duct_end_point_intake_down.png")
...
sprites_builder.setFilename(duct_end_points_sprite_path .. "duct_end_point_intake_left.png")
...
duct_end_point_intake_picture = sprites_builder.getPicture4Parts
(
...
duct_end_point_intake_load_unload_pictures =	
{
	north = 
	{
...
sprites_builder.setFilename(duct_end_points_sprite_path .. "duct_end_point_outtake_up.png")
sprites_builder.setShadow(duct_end_points_sprite_path .. "duct_end_points_up_shadow.png")
local duct_end_point_outtake_north = sprites_builder.buildImage()

sprites_builder.setFilename(duct_end_points_sprite_path .. "duct_end_point_outtake_right.png")
sprites_builder.setShadow(duct_end_points_sprite_path .. "duct_end_points_right_shadow.png")
local duct_end_point_outtake_east = sprites_builder.buildImage()

sprites_builder.setFilename(duct_end_points_sprite_path .. "duct_end_point_outtake_down.png")
sprites_builder.setShadow(duct_end_points_sprite_path .. "duct_end_points_down_shadow.png")
local duct_end_point_outtake_south = sprites_builder.buildImage()

sprites_builder.setFilename(duct_end_points_sprite_path .. "duct_end_point_outtake_left.png")
sprites_builder.setShadow(duct_end_points_sprite_path .. "duct_end_points_left_shadow.png")
local duct_end_point_outtake_west = sprites_builder.buildImage()

duct_end_point_outtake_picture = sprites_builder.getPicture4Parts
(
...
duct_end_point_outtake_load_unload_pictures =	
{
	north = 
	{
...
duct_end_point_intake_south.icon_size = 32
...
duct_end_point_intake_south.collision_box = {{-0.75, -0.75}, {0.75, 0.75}}
