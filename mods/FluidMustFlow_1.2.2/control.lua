...
local possible_connections=
{
	...
	["duct-curve"] = {4, 0}, 
	["duct-cross"] = {8, 0}, 
	["duct-underground"] = {4, 0},
	-- Intermediate points
	["non-return-duct"] = {4, 0},
	-- End points
	["duct-end-point-intake-south"] = {2, 6}, 
	["duct-end-point-intake-west"] = {2, 6}, 
	["duct-end-point-intake-north"] = {2, 6}, 
	["duct-end-point-intake-east"] = {2, 6}, 
	["duct-end-point-outtake-south"] = {2, 6}, 
	["duct-end-point-outtake-west"] = {2, 6}, 
	["duct-end-point-outtake-north"] = {2, 6}, 
	["duct-end-point-outtake-east"] = {2, 6}
}
...
function isaIntermediatePoint(entity_name)	
	if fmf_connection_point_part_names[entity_name] then
		return true
	end
	return false
end
