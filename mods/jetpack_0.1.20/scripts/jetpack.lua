  ...
  if old.grid then
    for _, old_eq in pairs(old.grid.equipment) do
      ...
      if new_eq and new_eq.valid then
        ...
        if old_eq.type == "battery-equipment"
          or old_eq.type == "energy-shield-equipment"
          or old_eq.type == "movement-bonus-equipment"
          or old_eq.type == "roboport-equipment"
          or old_eq.type == "night-vision-equipment"
          then
