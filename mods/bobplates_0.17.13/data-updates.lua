...
if settings.startup["bobmods-plates-nuclearupdate"].value == true then
  ...
  bobmods.lib.recipe.add_result("nuclear-fuel-reprocessing", {type="item", name="uranium-235", amount=1, probability=0.1})
  bobmods.lib.recipe.add_result("nuclear-fuel-reprocessing", {type="item", name="plutonium-239", amount=1, probability=0.4})
  bobmods.lib.recipe.add_result("nuclear-fuel-reprocessing", {type="item", name="fusion-catalyst", amount=1, probability=0.5})
else
