...
RecGen:create("omnimatter","omnicium-plate-mix"):
	...
	ifModsAddIngredients("only-smelting",{"angels-ore1-crushed",4},{"angels-ore3-crushed",4}):
	ifAddIngredients(not mods["only-smelting"],{"copper-ore",1},{"iron-ore",1}):
...
BuildGen:create("omnimatter","omni-furnace"):
	setEnergy(5):
	setIngredients({ "omnicium-plate", 10},{ "stone-brick", 5},{ "stone-furnace", 1}):
	setStacksize(20):
	setSize(2):
...
RecGen:import("pellet-iron-smelting"):
	...
	replaceIngredients("solid-limestone",{type="fluid", name="omnic-acid", amount = 60}):
