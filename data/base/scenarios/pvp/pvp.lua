...
function set_player(player, team, mute)
  ...
  local position = surface.find_non_colliding_position("character", force.get_spawn_position(surface), 0, 2)
...
pvp.on_configuration_changed = function(data)
  ...
  script_data.team_names = script_data.team_names or (update_teams_names() and script_data.team_names)
...
local script_events =
{
  ...
  [defines.events.on_player_respawned] = on_player_event_refresh_gui,
