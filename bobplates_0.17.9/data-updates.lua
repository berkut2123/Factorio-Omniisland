...
if settings.startup["bobmods-plates-purewater"].value == true then
  ...
  bobmods.lib.recipe.remove_result("heavy-water", "water") -- There is no replace_result.
  bobmods.lib.recipe.add_result("heavy-water", {type = "fluid", name = "pure-water", amount = 99.5})
